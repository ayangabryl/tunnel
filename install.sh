...
main() {
    ...
    # For now, create the script directly (later can use curl from GitHub)
...
TUNNEL_SCRIPT
    ...
    print ""
    print "  ${GREEN}${BOLD}Installation complete!${NC}"
    print ""
    print "  ${DIM}Restart your terminal or run:${NC}"
    print "    ${CYAN}source $SHELL_RC${NC}"
    print ""
    print "  ${DIM}Then start with:${NC}"
    print "    ${CYAN}tunnel${NC}"
    print ""
}
